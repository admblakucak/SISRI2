    ...
    <div class="modal" id="modaladd">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="<?= base_url() ?>tambah_bimbingan_revisi_skripsi_dosen" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                            ...
                            <?php if ($sebagai == 'Penguji 1' || $sebagai == 'Penguji 2' || $sebagai == 'Penguji 3') { ?>
                                <div class="col-auto">
                                    <?php if ($status_acc_revisi == NULL) { ?>
                                        <!-- <form action="<?= base_url() ?>acc_revisi_skripsi_dosen" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                        ...
                                        <button class="btn btn-sm btn-warning" type="button" data-toggle="modal" data-target="#exam pleModal" data-bs-target="#modalConfirm" data-bs-toggle="modal">ACC REVISI</button>
                            ...
                            <script>
                                $(document).ready(function() {
                                    setInterval(function() {
                                        $.get("<?= base_url() . "reload_m_bimbingan_revisi_skripsi_dosen/$nim" ?>", function(result) {
                            ...
                            <div class="modal" id="modaldel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content modal-content-demo">
                                        ...
                                        <form action="<?= base_url() ?>hapus_bimbingan_revisi_skripsi_dosen" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
