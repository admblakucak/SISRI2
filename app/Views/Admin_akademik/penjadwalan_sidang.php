                ...
                <div class="panel panel-primary tabs-style-2">
                    <div class="tab-menu-heading">
                        <div class="tabs-menu1">
                            <ul class="nav panel-tabs main-nav-line">
                                ...
                                <li><a href="#sidang_skripsi" class="nav-link" data-bs-toggle="tab">Sidang Skripsi</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel-body tabs-menu-body main-content-body-right border">
                        <div class="tab-content">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="btn-group">
                                                                    <form action="<?= base_url() ?>data_pendaftar_akademik" method="POST" enctype="multipart/form-data">
                                                                        <?= csrf_field() ?>
                                                                        <input type="hidden" name="id_jadwal" value="<?= '$key->id_jadwal' ?>" />
                                                                        <input type="hidden" name="idunit" value="<?= $idunit ?>" />
                                                                        <input type="hidden" name="idjadwal" value="<?= $key->id_jadwal ?>" />
                                                                        <input type="hidden" name="idjurusan" value="<?= $idjurusan ?>" />
                            ...
                            <div class="tab-pane" id="sidang_skripsi">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="table-responsive">
